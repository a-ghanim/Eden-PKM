...
export function ChatInterface() {
  ...
  const suggestedQueries = [
    ...
    "Find connections between my saves",
  ];
    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="absolute right-0 top-0 bottom-0 w-full max-w-lg bg-background border-l shadow-xl flex flex-col"
        ...
        >
          <header className="flex items-center justify-between p-4 border-b">
            <div className="flex items-center gap-2">
              ...
              <div>
                <h2 className="font-semibold">Ask Eden</h2>
            ...
            {chatMessages.length === 0 ? (
              <div className="h-full flex flex-col items-center justify-center text-center p-6">
                ...
                <p className="text-sm text-muted-foreground mb-6">
                  Eden can search, summarize, and find connections across
